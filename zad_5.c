...
/*
     6. Napisati C program koji će korisniku omogućiti unos realnog broja koji je veći od 0 i manji od 1 s
    barem tri decimalna mjesta i pomoću standarda IEEE 754 jednostruke preciznosti pretvoriti broj u
    binarni ekvivalent popunjavanjem cjelobrojnog polja duljine 32 elementa. Pripaziti na postupak
...
int main(void) {
    ...
    do {
        ...
        scanf("%f", &num);
    } while (num < 0.0f || num > 1.0f || has_dec_places(num, 3) == 0);
